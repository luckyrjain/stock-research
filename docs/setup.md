...
`df6b59581b8b_add_broker_connections_table.py` (`broker_connections`, 1 table), and
`6c43f4a2d489_add_broker_connections_per_account_api_.py` (that table's per-connection
`api_key`/`api_secret_enc` columns, no new table) — creating all 23 tables, indexes, and
